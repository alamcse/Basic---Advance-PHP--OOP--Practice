...
<div class="col-xs-6 col-sm-12 col-md-4 col-lg-6"style="background:#F5F5F5;min-height:510px">
			 ...
			 <div class="panel panel-default"style="margin-left:0px;">
                    ...
                    <div class="panel-body" style="overflow-y: scroll;height:450px;">
                    	<a href="insert_image.php" class="btn btn-success pull-right"> Insert Image</a>
                    	<br><br>
                         <table class="table table-hover table-bordered"style="text-align:center">
                    		...
                    		<tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td> <a href="edit_image.php?id=<?php echo $row['image_id']?>">Edit</a>
                                             <a href="delete_image.php?id=<?php echo $row['image_id']?>">Delete</a>
                                        </td>
                                   </tr>
                                   <?php
                                        }
