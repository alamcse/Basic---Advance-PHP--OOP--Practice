...
<div class="col-xs-6 col-sm-12 col-md-4 col-lg-6"style="background:#F5F5F5;min-height:510px">
			 ...
			 <div class="panel panel-default"style="margin-left:0px;">
                    ...
                    <div class="panel-body" style="overflow-y: scroll;height:450px;">
                    	<a href="edit_banner_image.php" class="btn btn-success pull-right"> Update Image</a>
                    	<br><br>
                                   ...
                                   <?php
                                        ...
                                        <img src="../img/<?php echo $row['banner_image']?>">
                                        <br>
                                        <a href="edit_banner_image.php?id=<?php echo $row['banner_id']?>">Edit</a>
                                             <a href="delete_banner_image.php?id=<?php echo $row['banner_id']?>">Delete</a>
